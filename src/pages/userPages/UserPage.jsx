  ...
  return (
    <div className="container pt-4">
      <div className="py-5 border-b-[1.5px] border-[#6D6E76] flex justify-between items-center">
        ...
        <button onClick={openModal} className="py-2 px-5 bg-green-700">
          Add post
        </button>
      </div>
      <div>
                  ...
                  ({ category, title, description, _id, photo }) => (
                    ...
                    >
                      ...
                      <div className="min-[550px]:w-1/2 max-[550px]:w-full max-[550px]:px-4 pb-3">
                        ...
                        <Link
                            to={`/posts/${_id}`}
                            className="cursor-pointer border items-center flex sm:py-2 sm:px-7 hover:bg-green-400 bg-red-900 py1 px-2 rounded-5"
                          >
                            More Info 👁
                          </Link>
                          <div
        ...
        >
          <div className="py-3 text-center">
            <img
              ...
              src={
                URL_IMG + photoModal?._id + "." + photoModal.name?.split(".")[1]
              }
              alt="Choose Img"
            />
